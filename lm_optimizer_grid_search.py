...
def main():  # pylint: disable=too-many-locals,too-many-branches,too-many-statements
    ...
    alphas = [0.6, 1.2, 1.8, 2.4, 3.0]
    betas = [0.6, 1.2, 1.8, 2.4, 3.0]

    args.lm_alpha = 0
    args.lm_beta = 0
    set_lm_options(args)

    sentence_measures, label_texts, predicted_texts = evaluate_with_transcribe(model, dataset, transcribe_options, normalizer=None)
    ...
    print(f"Alpha: 0, Beta: 0, WER: {current_wer:.4f}, SUB: {sub_rate:.4f}, DEL: {del_rate:.4f}, INS: {ins_rate:.4f}")
    ...
    for a in alphas:
        ...
        for b in betas: 
            ...
            print('Transcribe Options:' + str(transcribe_options))
            ...
            print(f"Alpha: {a}, Beta {b}, WER: {current_wer:.4f}, SUB: {sub_rate:.4f}, DEL: {del_rate:.4f}, INS: {ins_rate:.4f}")
