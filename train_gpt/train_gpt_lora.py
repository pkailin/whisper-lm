...
# Load the JSON array
with open("combined4_filtered.json", "r") as f:
    data = json.load(f)

# Write as JSON Lines
with open("combined4_lines.json", "w") as f:
    for item in data:
        f.write(json.dumps(item) + "\n")

# If your file is JSON Lines (Option A):
dataset = load_dataset("json", data_files="combined4_lines.json", split="train")
...
# Train the model
trainer.train(resume_from_checkpoint='./gpt_lora_comb4/checkpoint-192879')

# Save the model and tokenizer explicitly
model_output_dir = './gpt_lora_comb4'
